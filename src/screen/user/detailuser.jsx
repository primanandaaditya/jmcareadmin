                                ...
                                <div className="table-responsive">
                                    <table className="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <td className="text-left">{data.current.strprovinsi}</td>
                                        </tr>
                                        <tr>
                                            <td className="text-left">Kabupaten/kotamadya</td>
                                            <td className="text-left">{data.current.strkabupaten}</td>
                                        </tr>
                                        <tr>
                                            <td className="text-left">Kecamatan</td>
                                            <td className="text-left">{data.current.strkecamatan}</td>
                                        </tr>
                                        <tr>
                                            <td className="text-left">Kelurahan</td>
                                            <td className="text-left">{data.current.strkelurahan}</td>
                                        </tr>
                                        <tr>
